...
import { Calendar, Video, Phone, MapPin, Trash2, Paperclip, Upload, FileText, X, Download } from "lucide-react";
...
// Attachments panel — list of files pinned to an interview + an
// upload button. Shared MIME/size policy with the other document
// endpoints, surfaced as a 10MB cap in the helper text. Errors come
// from the server (file too large, type not allowed, blob not
// configured) and render inline rather than alerting so the rest of
// the form stays usable.
function InterviewAttachments({ interviewId }: { interviewId: string }) {
